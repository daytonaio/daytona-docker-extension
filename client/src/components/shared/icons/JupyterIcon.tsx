...
export default function JupyterIcon(props: any) {
  return (
    <SvgIcon {...props}>
      <svg
        width="24"
      ...
      >
        ...
        <g id="Canvas" transform="translate(-1640 -2453)">
          <g id="Group" style={{ mixBlendMode: 'normal' }}>
            <g id="Group" style={{ mixBlendMode: 'normal' }}>
              <g id="Group" style={{ mixBlendMode: 'normal' }}>
                <g id="g" style={{ mixBlendMode: 'normal' }}>
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path9 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
                  ...
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path10 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
                  ...
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path11 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
                  ...
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path12 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
                  ...
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path13 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
                  ...
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path14 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
                  ...
                  <g id="path" style={{ mixBlendMode: 'normal' }}>
                    <g id="path15 fill" style={{ mixBlendMode: 'normal' }}>
                      <use
              ...
              <g id="g" style={{ mixBlendMode: 'normal' }}>
                <g id="path" style={{ mixBlendMode: 'normal' }}>
                  <g id="path16 fill" style={{ mixBlendMode: 'normal' }}>
                    <use
                ...
                <g id="path" style={{ mixBlendMode: 'normal' }}>
                  <g id="path17 fill" style={{ mixBlendMode: 'normal' }}>
                    <use
                ...
                <g id="path" style={{ mixBlendMode: 'normal' }}>
                  <g id="path18 fill" style={{ mixBlendMode: 'normal' }}>
                    <use
                ...
                <g id="path" style={{ mixBlendMode: 'normal' }}>
                  <g id="path19 fill" style={{ mixBlendMode: 'normal' }}>
                    <use
                ...
                <g id="path" style={{ mixBlendMode: 'normal' }}>
                  <g id="path20 fill" style={{ mixBlendMode: 'normal' }}>
                    <use
